...
@property (nonatomic, copy) void(^btnAction)(NSInteger index);
    
@end
@implementation MM_SegmentView

- (instancetype)initWithAction:(void (^)(NSInteger))action {
